...
class LoginViewController: BaseViewController {
    ...
    @IBOutlet weak var passwordTextField: UITextField! {
        didSet {
            passwordTextField.placeholder = "Contraseña" // TODO: In a next PR, chain management will be added
        }
    }
    ...
    private func setupTest() {
        ...
        userTextField = TextField(configuration: userTextFieldConfiguration)
